...
class SigningView(APIView, Authentication):
    ...
    def post(self, request):
        ...
        accss_token = RefreshToken.for_user(signin).access_token
        return Response({
            "user": user,
            "accss_token": str(accss_token)
        })
...
class UserView(APIView):
    ...
    def put(self, request):
        ...
        storage = FileSystemStorage(
            Path(settings.MEDIA_ROOT)/ "avatars",
